import { CalendarCheck, ChevronDown, ChevronUp, Server, ShieldCheck, Users } from 'lucide-react'
...
export default function Teams() {
  ...
  const loadTeam = async (guild: GuildSummary, create: boolean) => {
    ...
    try {
      ...
      if (create) {
        ...
        toast.success('Discord 서버와 TORO 팀을 연결했어.')
      }
    } catch (error) {
